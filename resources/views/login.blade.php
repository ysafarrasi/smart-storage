                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    <div class="col">
                        <div class="card shadow-sm">
                            <video controls>
                                <source src="assets/vid/papan.mp4" type="video/webm" class="d-block w-100" />
                            </video>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="assets/img/Showcase Design 2_page-0001.jpg" class="d-block w-100"
                                            alt="...">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="assets/img/Showcase Design 2_page-0002.jpg" class="d-block w-100"
                                            alt="...">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="assets/img/Showcase Design 2_page-0003.jpg" class="d-block w-100"
                                            alt="...">
                                    </div>
                                </div>
